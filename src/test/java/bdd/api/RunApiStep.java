...
public class RunApiStep {
    ...
    public void setConfigHeaders(DataTable dataTable) {
    ...
    public void setConfigBodyService(String servicio, DataTable dataTable) {
    ...
    public void executeServiceAPI(DataTable dataTable) {
    ...
    public boolean validateStatusCode(int codigoRespuesta) {
        return $response.getStatusCode() == codigoRespuesta;
    }

    @Step("Valido que la respuesta del body sea el adecuado")
    public void validateResponseBody(DataTable dataTable) throws IOException {
